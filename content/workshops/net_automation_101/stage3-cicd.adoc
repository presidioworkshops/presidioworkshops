...
=== Logout of the Gitlab-CE Web Interface as a user
...
=== Click Linux Runner and add a Tag of Netdevops and check “run untagged jobs” click create runner
...
image::s3-15.png[caption="Figure 1: ", title='Gitlab Runner', 200]
...
=== Login to the Gitlab Runner Server as gitlab-runner (Server-1) 
...
# fi
----
Shift + zz to save and exit the file
[source, bash]
----
sudo visudo
----
=== Now add the following to the bottom of the file and type CTRL + X and enter to save the file
[source, bash]
----
gitlab-runner ALL=(ALL) NOPASSWD: ALL 
----

image::s3-16.png[caption="Figure 2: ", title='Gitlab Permission', 200]
...
image::s3-17.png[caption="Figure 3: ", title='Gitlab Runner', 500]

---

== **Let's Create A CI/CD Pipeline**
=== Log out of Admin and login to the Gitlab-CE Web Interface as a User
...
image::s3-18.png[caption="Figure 4: ", title='Gitlab Pipeline Editor', 500]
...
image::s3-19.png[caption="Figure 4: ", title='Gitlab Pipeline', 500]
...
image::s3-20.png[caption="Figure 5: ", title='Updated The Pipeline', 500]
...
image::s3-21.png[caption="Figure 6: ", title='Failed Pipeline', 200]
...
=== Lets automate the backup the of configs and upload the configurations to Gitlab
== Create a new repository on the Gitlab-CE Server called Backup
[IMPORTANT]
Uncheck "initialize repository with a README"

image::s3-22.png[caption="Figure 7: ", title='Backup Repository', 500]
...
image::s3-23.png[caption="Figure 8: ", title='SSH Key', 300]

=== Paste the key in the key text box and click add key

image::s3-24.png[caption="Figure 9: ", title='Paste SSH Key', 500]
...
gitlab-runner@ed26757f4b1c:~/network-automation/backup$ pu
[master (root-commit) 0c4e95b] Initial commit
...
Writing objects: 100% (8/8), 2.11 KiB | 215.00 KiB/s, done.
Total 8 (delta 4), reused 0 (delta 0)
To server2:knorton/backup.git
...
image::s3-25.png[caption="Figure 10: ", title='Update PipeLine To Reflect Git Backup', 500]
...
image::s3-26.png[caption="Figure 11: ", title='Switch Configuration In Git Backup', 400]
