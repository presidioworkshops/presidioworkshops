...
<blockquote>
<i class="fa fa-info-circle"></i>  A deployment in Kubernetes is a replication controller based on a user defined template called a deployment configuration <br/>
</blockquote>
